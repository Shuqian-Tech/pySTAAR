...
- STAAR-35: Add related-workflow pure-path parity shadow scenarios (`use_precomputed_artifacts: false`) with explicit blocker tracking where needed. (Resolved; active shadow xfails are now tagged to `DEV-001`)
