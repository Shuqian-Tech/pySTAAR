...
- STAAR-49: Add distinct non-`example` R-baseline parity for at least one additional related workflow family beyond sparse GLMMkin (for example related binary SPA or related conditional GLMMkin). (Open)
