...
- STAAR-47: Add a distinct (non-clone) non-`example` R baseline extraction and matching Python parity scenario family for release gating beyond runtime example-directory copies. (Open)
